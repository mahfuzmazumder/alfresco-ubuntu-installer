...
mv /tmp/solr/alfresco-search-services /home

# Variables
SOLR_USER=ubuntu
SOLR_GROUP=ubuntu
SOLR_HOME=/home/alfresco-search-services
...
ExecStart=/home/alfresco-search-services/solr/bin/solr start -a "-Dcreate.alfresco.defaults=alfresco,archive -Dalfresco.secureComms=secret -Dalfresco.secureComms.secret=secret"
ExecStop=/home/alfresco-search-services/solr/bin/solr stop
