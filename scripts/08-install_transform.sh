...
mkdir /home/transform
cp downloads/alfresco-transform-core-aio-5.1.0.jar /home/transform

# Variables
TRANSFORM_USER=ubuntu
TRANSFORM_GROUP=ubuntu
TRANSFORM_HOME=/home/transform
...
ExecStart=java -jar /home/transform/alfresco-transform-core-aio-5.1.0.jar
